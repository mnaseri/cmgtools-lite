...
from CMGTools.RootTools.samples.triggers_13TeV_DATA2016 import triggers_dijet55met110, triggers_1mu_iso, triggers_1e, triggers_mumu, triggers_ee, triggers_MET170_HBHECleaned, triggers_1mu_noniso, triggers_1e_noniso, triggers_mumu_noniso, triggers_ee_noniso, triggers_mumu_ht, triggers_ee_ht, triggers_metNoMu90_mhtNoMu90, triggers_met90_mht90
...
'METnoMu_MHTnoMu': triggers_metNoMu90_mhtNoMu90,
'MET_MHT': triggers_met90_mht90,
}
...
if sample == "MC":
	...
	#selectedComponents = SingleTop #ZJetsToNuNuHT
	selectedComponents = [ZJetsToNuNu_HT600to800] # [ZJetsToNuNu_HT600to800,ZJetsToNuNu_HT2500toInf] #ZJetsToNuNuHT
	...
	selectedComponents = [MET_Run2016B_PromptReco_v2, MET_Run2016C_PromptReco_v2, MET_Run2016D_PromptReco_v2]

	if test==1: 

		comp = DoubleMuon_Run2016B_PromptReco_v2
		comp.fineSplitFactor = 1  
	#	comp.files = comp.files[:2]
		selectedComponents = [comp]
		comp.splitFactor = 1
		#comp.splitFactor = len(comp.files)
                comp.json = '/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions16/13TeV/Cert_271036-276811_13TeV_PromptReco_Collisions16_JSON.txt'  
	elif test==2:
		for comp in selectedComponents:
			comp.splitFactor = 1
			comp.fineSplitFactor = 2
		...
		for comp in selectedComponents:
			...
			#comp.splitFactor = 1
                        comp.json = '/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions16/13TeV/Cert_271036-276811_13TeV_PromptReco_Collisions16_JSON.txt'  
                        comp.trigger = triggers_mumu+ triggers_ee+ triggers_mumu_noniso+ triggers_ee_noniso+ triggers_metNoMu90_mhtNoMu90 + triggers_met90_mht90 + triggers_MET170_HBHECleaned + triggers_1mu_noniso + triggers_1e_noniso
