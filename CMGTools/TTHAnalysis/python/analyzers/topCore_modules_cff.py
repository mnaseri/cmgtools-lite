...
lepAna = cfg.Analyzer(
    ...
    inclusive_muon_dxy = 100,
    inclusive_muon_dz  = 100.0,
...
ttHLepSkim = cfg.Analyzer(
    ...
    ptCuts = [],                # can give a set of pt cuts on the leptons
...
# top quark topology based Skim (generic, but requirements depend on the final state)
from CMGTools.TTHAnalysis.analyzers.topAnalysisSkimmer import topAnalysisSkimmer
topAnalysisSkim = cfg.Analyzer(
   topAnalysisSkimmer, name='topAnalysisSkimmer',
